...
Read the code in call.asm for the functions g, f, and main. The instruction manual for RISC-V is on [the reference page](https://pdos.csail.mit.edu/6.828/2020/reference.html). 
